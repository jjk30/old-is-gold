    ...
    <div className="login-page">
      <div className="login-container">
        <Link to="/" className="login-brand">
          <span className="brand-old">Old</span>
          <span className="brand-is-gold"> Is Gold</span>
        </Link>
          ...
          <form onSubmit={handleSubmit}>
            {isSignUp && (
              <div className="form-group">
                ...
                <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Enter your name" className="form-input" />
              </div>
            )}
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" className="form-input" required minLength={6} />
            </div>
